...
func ListEndpoints(t *Table, count int) ([]route.Endpoint, error) {
	for i := 0; i < 100; i++ {
...
func TestTable(t *testing.T) {
	...
	endpoints := []*route.Endpoint{
		&route.Endpoint{Name: "node0", Net: "tcp", Addr: "localhost:2000", Load: 0.0},
		&route.Endpoint{Name: "node1", Net: "udp", Addr: "localhost:2001", Load: 0.1},
		&route.Endpoint{Name: "node2", Net: "tcp", Addr: "localhost:2002", Load: 0.2},
